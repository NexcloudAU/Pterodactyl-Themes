        ...
        <div class="container">
            <div id="login-position-elements">
                ...
                <p class="small login-copyright text-center">
                    Copyright &copy; 2015 - {{ date('Y') }} <a href="https://pterodactyl.io/" target="_blank">Pterodactyl Software</a>. | Theme: <a href="https://fonix.online/">Fonix</a><br />
                </p>
            </div>
        </div>
        <div class="login-corner-info small">
            <strong><i class="fa fa-fw {{ $appIsGit ? 'fa-git-square' : 'fa-code-fork' }}"></i></strong> {{ $appVersion }} / T-1.3<br />
